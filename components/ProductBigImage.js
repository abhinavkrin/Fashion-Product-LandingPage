...
export default function ProductBigImage({src,alt,isDetailedView, imageRef}){
	...
	return (
		<div className="w-full h-full relative flex flex-col">
			<div style={{position: "absolute", top: "50%", left: "45%", transform: "translate(-55%, -50%)", zIndex: 1, width: (isDetailedView?"120%":"700px")}} className="flex justify-end pt-30 2xl:pt-32">
